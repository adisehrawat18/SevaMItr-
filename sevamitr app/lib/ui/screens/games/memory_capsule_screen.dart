...
class _MemoryCapsuleScreenState extends State<MemoryCapsuleScreen> {
  ...
  void _playStoryAudio(MemoryCapsule capsule) {
    setState(() => _isPlayingAudio = true);
    RegionalTtsService()
        .speak("${capsule.audioStoryText} ${capsule.audioStoryTextRegional}");
  }
          ...
          Container(
            ...
            child: Column(
              ...
              children: [
                ...
                Text(
                  capsule.audioStoryTextRegional,
                  style: const TextStyle(
                    fontSize: 16,
