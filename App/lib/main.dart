...
import 'package:dementia_ner_care/ui/screens/games/bijuli_tap_screen.dart';
import 'package:dementia_ner_care/ui/screens/games/bikhama_khoj_screen.dart';
import 'package:dementia_ner_care/ui/screens/games/double_decision_screen.dart';
import 'package:dementia_ner_care/ui/screens/games/sound_sweeps_screen.dart';
import 'package:dementia_ner_care/ui/screens/games/speed_maze_screen.dart';
import 'package:dementia_ner_care/ui/screens/games/target_tracker_screen.dart';
              ...
              switch (_currentRoute) {
                ...
                case AppRoute.gamesHub:
                  return GamesHubScreen(
                    ...
                    onSelectBijuliTap: () =>
                        _navigateTo(AppRoute.gameBijuliTap),
                    onSelectBikhamaKhoj: () =>
                        _navigateTo(AppRoute.gameBikhamaKhoj),
                    onSelectDoubleDecision: () =>
                        _navigateTo(AppRoute.gameDoubleDecision),
                    onSelectSoundSweeps: () =>
                        _navigateTo(AppRoute.gameSoundSweeps),
                    onSelectSpeedMaze: () =>
                        _navigateTo(AppRoute.gameSpeedMaze),
                    onSelectTargetTracker: () =>
                        _navigateTo(AppRoute.gameTargetTracker),
                ...
                case AppRoute.gameBijuliTap:
                  return BijuliTapScreen(
                    onBackToHub: () => _navigateTo(AppRoute.gamesHub),
                  );

                case AppRoute.gameBikhamaKhoj:
                  return BikhamaKhojScreen(
                    onBackToHub: () => _navigateTo(AppRoute.gamesHub),
                  );

                case AppRoute.gameDoubleDecision:
                  return DoubleDecisionScreen(
                    onBackToHub: () => _navigateTo(AppRoute.gamesHub),
                  );

                case AppRoute.gameSoundSweeps:
                  return SoundSweepsScreen(
                    onBackToHub: () => _navigateTo(AppRoute.gamesHub),
                  );

                case AppRoute.gameSpeedMaze:
                  return SpeedMazeScreen(
                    onBackToHub: () => _navigateTo(AppRoute.gamesHub),
                  );

                case AppRoute.gameTargetTracker:
                  return TargetTrackerScreen(
                    onBackToHub: () => _navigateTo(AppRoute.gamesHub),
                  );
